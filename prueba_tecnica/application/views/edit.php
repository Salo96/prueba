...
<body>
    ...
    <div class="container" style="padding-top: 10px;">
        ...
        <hr>
        <form method="post" name="createUser" action="<?php echo base_url().'index.php/controller_product/edit/'. $product['id_producto']; ?>">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="producto">Nombre del producto</label>
                        <input type="text" name="producto" class="form-control" value="<?=set_value('producto', $product['nombre_producto'])?>">
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" class="form-control"   style="height:100px;"> <?=set_value('descripcion', $product['descripcion'])?> </textarea>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cantidad" class="form-control" value="<?=set_value('cantidad', $product['cantidad'])?>">
                        <?php
